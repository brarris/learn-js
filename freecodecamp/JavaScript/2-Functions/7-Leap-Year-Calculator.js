 ...
 * For example, `2000` is a leap year, but `1900` is not. Also, a leap year has an extra day in February,
...
const isLeapYear = () => {
  let resultString;
  if (year % 400 === 0) {
    resultString = year + " is a leap year.";
  } else if (year % 100 === 0) {
    resultString = year + " is not a leap year.";
  } else if (year % 4 === 0) {
    resultString = year + " is a leap year.";
  } else {
    resultString = year + " is not a leap year.";
